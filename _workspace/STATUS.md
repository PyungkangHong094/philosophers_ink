...
- 마일스톤: **M3 완료 — 게이트 GO** (게이트 QA PASS 7 / FAIL 0, `_workspace/qa_m3_gate_20260718.md`)
- 마지막 갱신: 2026-07-18
...
- 에디터 파일쓰기 path_provider 바인딩 (맥 이전으로 개발자 모드 제약 소멸 — M4에서 배선 가능)
- level_player/debug_hud 디버그 UI 하드코딩 색 → M4 셸 디자인 시스템으로 대체
- 인앱 에디터 기믹 저작 UI (M3 스키마는 왕복 무손실로 통과만, 저작 도구는 미구현)
...
- M4 콘텐츠 1: 챕터 1–2 레벨 33개(level-designer 팬아웃) + 셸 UI 1차(GDD 8.4 트루 블랙+골드, shell-ui-engineer) + qa
